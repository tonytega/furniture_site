        ...
        <section className="AboutUs-Section1">
            ...
            >
                <div>
                    ...
                    <a><button className="btn btn-outline-primary mt-2" style={{color:'#fff'}}>  homepage</button></a>
                    <a><button className="btn btn-outline-primary ms-3 mt-2" style={{color:'#fff'}}> contact us</button></a>
                </div>
